  ...
  return (
      <div className='flex flex-col gap-3 '>
          <div className='w-96 flex min-h-96 flex-col items-center'>
              <h1 className='text-xl w-1/2 font-bold text-center'>Distribución por</h1>
              <Tabs selectedKey={selectedDataset} onSelectionChange={updateSelectedDataset} color='primary' aria-label="Options">
